 ...
 * @since 1.0
 */
public class SMTPAppender extends AppenderSkeleton implements
	...
	protected void sendBuffer() {
		threadPool.execute(new Log4jMailSender());
	}

	class Log4jMailSender implements Runnable {
				...
				if (allAscii) {
					...
					try {
						...
						Writer writer = new OutputStreamWriter(
								MimeUtility.encode(os, "quoted-printable"),
								"UTF-8");
						writer.write(s);
						writer.close();
