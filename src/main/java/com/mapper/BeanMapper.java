...
public class BeanMapper {
	 ...
	 */
	public static <T> List<T> mapList(Collection sourceList, com.utils.convert.Convert<T> convert) {
	...
	public static <T> Set<T> mapSet(Collection sourceList, com.utils.convert.Convert<T> convert) {
