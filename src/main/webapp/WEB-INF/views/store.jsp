...
<html lang="zh">
	<head>
        ...
        <style>
            ...
            .nav_second_level{
                background: url(${resources}/static/images/2.0/game-selected.png) no-repeat;
            ...
            .nav_second_level a{
             ...
             .app{
                background: url(${resources}/static/images/2.0/app-selected.png) no-repeat;
                 background-size: 100% 100%;
            }
            .v-list .down-area {
                right: 80px;
		...
		<form method="get">
			...
			<div id="container">
                <div id="nav_second_level" class="nav_second_level">
                    <a id="male" href="javascript:jumpByGender('store/game')">精品游戏</a>
                    <a id="female" href="javascript:jumpByGender('store/app')">免费软件</a>
                </div>
                <div class="content ajax-wrap">
                    <ul class="v-list J_ajaxWrap">
                        <c:forEach items="${fileStoreInfos  }" var="fileStoreInfo">
                            <%@include file="store-app.jsp"%>
                        </c:forEach>
                    </ul>
                    <div class="footer">
                        <div class="J_scrollLoadMore load-btn click-state" data-api="app/${gender }/store/${type }/p"></div>
        ...
        <script src="${tomcat }/static/zepto/android.js"></script>
		  ...
		  $(function(){
              ...
              if(reg("sf")=='game'||location.href.indexOf("game")>0){
                  ...
                  $("#banner").attr("href","${ums2}/log/redirect?url=http://ytao.cn/?id=141061tp_tpchannel=1236619");
                  $("#banner > img").attr("src","${resources}/static/images/2.0/ad/ytMi2p.jpg");
              }else{
                  $("#nav_second_level").addClass("app");
                  $("#banner").attr("href","${ums2}/log/redirect?url=http://ytao.cn/index.php?id=66457tp_tpchannel=1236615");
                  $("#banner > img").attr("src","${resources}/static/images/2.0/ad/ytxjlyq.jpg");
              }
